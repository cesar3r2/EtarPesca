	...
	{								
		...
		if(stristr($s, 'auditoria.auditoria')==FALSE)
		{
			...
			{					
					...
					$hora=date('h:i:s');
					$fecha=date('d/m/Y');																										
					$usuario =  $_SESSION['nickUsr'];
					$ipUser  =	$_SESSION['ipUser'];
					$macUser =  $_SESSION['macAddress'];					
					$SQL_bitacora="INSERT INTO auditoria.auditoria(timestamp_,hora,nombre_disparador, tipo_disparador, nivel_disparador, comando, tabla, sql_realizado, ip, usuario, mac)
		    					   VALUES ('$fecha','$hora','AUDITORIA', 'ALTER', 'STATEMENT', '$comando', 'TABLA', '$s', '$ipUser', '$usuario', '$macUser')";								  
					//echo $SQL_bitacora;
